...
<div class="cover-divider"></div>
<img class="cover-product" src="assets/images/ug-cover.png">
...
![Wi-Fi button location](assets/images/1.1%20Quick-Start-WiFi-Location.svg){.medium}

2. If no network is connected, press **Scan Wi-Fi** to search for available networks.

![Scan Wi-Fi](assets/images/2.2%20Scan-Wi-Fi.svg){.medium}
...
![Wi-Fi connection details](assets/images/3.1%20Wi-Fi-Connected-info.svg){.medium}
...
![Scan the QR code on the LCD](assets/images/4.%20Wi-Fi-Connected.svg){.medium}
...
![Main controls](assets/images/5.%20Main-Controls.svg){.medium}
...
![Zone control](assets/images/6.1%20Zone-Control.svg){.medium}
...
![Schedules screen](assets/images/7.1.%20Schedule-Screen-1.svg){.medium}

![Schedules overview](assets/images/8.1%20Schedule-Screen-2.svg){.medium}

![Schedule settings](assets/images/9.1%20Schedule-Settings-v2.svg){.medium}

![Scene settings](assets/images/10.%20Scene-Settings-v2.svg){.medium}
...
<p class="copyright-text">App Store is a service mark of Apple Inc. © 2019. Google Play and the Google Play logo are trademarks of Google LLC. All other trademarks and trade names are the property of their respective owners.</p>
