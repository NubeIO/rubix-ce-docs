...
![](Zoneconnex/img/ZoneConnex-Dimensions.png)
...
![](Zoneconnex/img/ACB-ZC-Components-Markup-Front-View.png)
...
![](Zoneconnex/img/ACB-ZC-Components-Markup-Top-View.png)
...
![](Zoneconnex/img/ACB-ZC-Components-Markup-Bottom-View.png)
...
![](Touch%20Point%20LCD/img/LCD-Dimensions.png)
...
![](Touch%20Point%20LCD/img/Internal-Components-Breakdown-rev2.png)
...
![](Touch%20Point%20LCD/img/LCD-Housing-Components.png)
...
![](Zoneconnex/img/ZoneConnex-DinMounting-V2.png)
...
![](Zoneconnex/img/ZoneConnex-FixingMounting-v2.png)
...
![](Touch%20Point%20LCD/img/LCD-Mounting-v3.png)

::: image-row
|   |   |
|---|---|
| ![](Touch Point LCD/img/Top-Retaining-Clips-v2.png) | ![](Touch Point LCD/img/Bottom-Retaining-Clips-v2.png) |
:::
...
|   |   |
|---|---|
|            | ![](ZoneConnex/img/ZC-24VAC-DC-Wiring.png) |
| Pin 1 **(L)** | 24V AC **Live (L)** |
| Pin 2 **(N)** | 24V AC **Neutral (N)** |
:::

![](ZoneConnex/img/24VAC-ADAPTOR-rev3.png)
...
![](ZoneConnex/img/ACB-ZC-UART-PAP-04V-S-rev2.png)
</div>

<div style={{ textAlign: 'center' }}>
![](ZoneConnex/img/UART-Cable.png)
</div>
...
|   |   |
|---|---|
|           	| ![](ZoneConnex/img/ZC-UART-Wiring.png) |
...
|   |   |
|---|---|
|           	| ![](ZoneConnex/img/ZC-LCD-RS485-Wiring.png)  |
...
|   |   |
|---|---|
|            | ![](ZoneConnex/img/ZC-LCD-Power-Wiring.png) |
| Pin 12 **(+)** | 18V DC **+** |
| Pin 13 **(-)** | 18V DC **−** |
:::
...
|   |   |
|---|---|
|            | ![](Touch%20point%20LCD/img/LCD-Wiring-Terminations.png) |
...
![](Touch%20point%20LCD/img/LCD-Stickered-Internal-Zoomed.png)
...
| Android  | iOS |
|----------|-----|
| ![](img/Andriod-anywair-zone-qr-code.png) | ![](img/iOS-anywair-zone-qr-code.png) |
| <a href="https://play.google.com/store/apps/details?id=com.nubeio.mia"> ![](MIA%20Mobile%20App/img/google-play-icon.png) </a>   | <a href="https://apps.apple.com/au/app/anywair-zone/id6748876162"> ![](MIA%20Mobile%20App/img/Apple-app-download-icon.png) </a> |
...
![](Touch%20point%20LCD/img/LCD-Screenshots/Scan-wi-fi-v2.png)
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Wi-Fi-Connected-info.png)
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Tap-Settings-Card.png)
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Installer-Connection-step1.png)
5. Once connected to the Zoneconnex Access Point Wi-Fi, Scan the right QR to access installer mode for the Zoneconnex.
![](Touch%20Point%20LCD/img/LCD-Screenshots/Installer-Connection-step2.png)
...
1. Enter the total number of zones and required relief zones, then press **Next**.  
   ...
   ![](MIA Mobile App/screenshots/5.png){.phone}
...
![](MIA Mobile App/screenshots/6.png){.phone}
...
3. Configure the first zone:
   - Set **Zone Name** - Rename the zone for easy identification by pressing the arrow `>` button beside the current zone name. After entering the desired name press the `Save` button to apply the changes or `cancel` button to cancel the changes. <br/>
      ![](MIA Mobile App/screenshots/7.png){.phone}
   ...
   ![](MIA Mobile App/screenshots/8.png){.phone}
   ...
   ![](MIA Mobile App/screenshots/9.png){.phone}
   ...
   ![](MIA Mobile App/screenshots/10.png){.phone}

   - **Minimum Airflow (%)** – Specify the minimum airflow percentage the zone should maintain during operation using the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} and minus ![minus button](MIA%20Mobile%20App/img/circle-minus.png){.icon} buttons. <br/>

   - **Maximum Airflow (%)** – Specify the maximum airflow percentage the zone can maintain during operation using the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} and minus ![minus button](MIA%20Mobile%20App/img/circle-minus.png){.icon} buttons. <br/>
   ![](MIA Mobile App/screenshots/11.png){.phone}
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/12.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/13.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/14.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/15.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/16.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/17.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/18.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/19.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/20.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/21.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/22.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/23.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/52.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/53.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/54.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/55.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>
...
<div class="img-row">
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/56.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
<figure>
<img class="phone" src="MIA%20Mobile%20App/screenshots/57.png" alt="anywAiR Zone app screenshot">
<figcaption></figcaption>
</figure>
</div>

4. After setting your username, the user is presented with terms and conditions. Tap 'Accept Terms' to accept the terms and conditions and complete the account creation. <br/>

5. You will be taken to the Setup Home screen. <br/>

6. Press Scan QR Code and scan the QR code displayed on the Touch Point LCD. <br/>

![](Touch%20Point%20LCD/img/LCD-Screenshots/Wi-fi-connected.png)

7. Enter a name for the home, then press Add Home. <br/>
8. You will be taken to the main control screen for your newly added home.<br/>
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/LCD-Navigation.png)
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Main-Controls.png)


### 6.2.1 Operation Control
Users can control the unit’s operation from the Home screen of the TouchPoint LCD using the operation ![Operation button](MIA%20Mobile%20App/img/power.png){.icon} button. When the unit is ON, the operation button is displayed in teal. When the unit is OFF, the power button is displayed in black paired with a 'System Off' status.
...
Users can increase or decrease the setpoint value using the increase ![increase button](MIA%20Mobile%20App/img/chevron-up.png){.icon} and decrease ![decrease button](MIA%20Mobile%20App/img/chevron-down.png){.icon} buttons to reach the desired setpoint. 
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Zone-Control.png)
...
Users can increase or decrease the airflow percentage value using the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} and minus ![minus button](MIA%20Mobile%20App/img/circle-minus.png){.icon} buttons to reach the desired airflow setting.
...
To create a schedule and scene, users can press the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} button on the Schedule/Scene screen to create a schedule. If no schedules have been created, users will also have the option to press the `+ Create your first schedule` button to open the creation screen.

![](Touch%20Point%20LCD/img/LCD-Screenshots/Schedule-Screen-1.png)
![](Touch%20Point%20LCD/img/LCD-Screenshots/Schedule-Screen-2.png)
...
1. Press the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} button on the Schedule/Scene screen or edit an existing schedule by pressing the arrow ![arrow button](MIA%20Mobile%20App/img/arrow-right.png){.icon} button on the schedule card to open the schedule settings screen.
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Schedule-Settings-v2.png)
...
5. Set the **Setpoint** temperature for the scene using the plus ![plus button](MIA%20Mobile%20App/img/circle-plus.png){.icon} and minus ![minus button](MIA%20Mobile%20App/img/circle-minus.png){.icon} buttons to reach the desired setpoint. 
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/Scene-Settings-v2.png)
...
![](Touch%20Point%20LCD/img/LCD-Screenshots/System-Info.png)
